...
export class Platformer {
    ...
    private render = (): void => {
        this._display.fill(this._world.backgroundColor());
        this._display.drawRectangle(this._player.getPosX(), this._player.getPosY(), this._player.getWidth(), this._player.getHeight(), this._player.getColor());
