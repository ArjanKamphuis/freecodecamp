import { CollidableObject } from "./MoveableObject";
import { Player } from "./Player";

export class Collider {
    public static collide = (value: number, object: CollidableObject, tileX: number, tileY: number, tileSize: number): void => {
        switch (value) {
    ...
    private static collidePlatformBottom = (object: CollidableObject, tileBottom: number): boolean => {
    ...
    private static collidePlatformLeft = (object: CollidableObject, tileLeft: number): boolean => {
    ...
    private static collidePlatformRight = (object: CollidableObject, tileRight: number): boolean => {
    ...
    private static collidePlatformTop = (object: CollidableObject, tileTop: number): boolean => {
